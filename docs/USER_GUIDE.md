...
This guide describes how to use the PagerDuty Customer Sim & Demo Platform (v2.4.3).
...
## Cloud Validation
v2.4.3 local validation is complete. Wider beta validation is in progress.
